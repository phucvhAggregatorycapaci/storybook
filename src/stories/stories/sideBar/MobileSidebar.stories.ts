...
// import Mobile from "../../widget/sideBar/Navmenu.vue"
import MobileSidebar from '../../widget/sideBar/MobileSidebar.vue'
import { action } from '@storybook/addon-actions'
import {Story} from "@storybook/vue3"

export default {
    title: 'common/sidebar/MobileSideBar',
...
const Template:Story = (args:any) => ({
    ...
    template: `<MobileSidebar v-bind="args" @click="click"/>`,

});

export const MobileSidebarCommon = Template.bind({});

MobileSidebarCommon.args = {
    items: [
        {
            isHeadr: true,
            title: "menuuuuu",
