...
import NavMenu from "../../widget/sideBar/Navmenu.vue"
import { action } from '@storybook/addon-actions'

export default {
    title: 'common/sidebar/NavMenu',
    component: NavMenu,
};
const Template:Story = (args) => ({
    ...
    template: `<NavMenu v-bind="args" @click="click"/>`,

});

export const NavMenuCommon = Template.bind({});
NavMenuCommon.args = {
    items: [
        {
            isHeadr: true,
