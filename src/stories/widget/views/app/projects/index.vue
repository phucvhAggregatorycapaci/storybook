...
<script setup>
import Breadcrumb from "@widget/components/Breadcrumbs";
import Button from "@widget/components/Button/index.vue";
import GridSkletion from "@widget/components/Skeleton/Project-grid";
import TableSkeltion from "@widget/components/Skeleton/Table";
