<template>
    ...
    >
        ...
        >
            ...
            <div
                class="flex-none flex items-center space-x-4 rtl:space-x-reverse"
            >
                <Tooltip placement="top" arrow>
                    <template #button>
        ...
        <div>
            ...
            <div
                class="flex space-x-3 pt-4 pb-6 items-start rtl:space-x-reverse"
            >
                <div class="flex-none">
            ...
            <div class="text-sm text-slate-600 dark:text-slate-300 font-normal">
                ...
                your blog post, if you want to get it right on of these 10
                clever ways to omen your next blog
                <br />
                <br />
                posr with a bang With resrpect, i must disagree with Mr.Zinsser.
                We all know the most part of important part of any article is
                the title.Without a compelleing title, your reader won't even
                get to the first sentence.After the title, however, the first
                few sentences of your article are certainly the most important
                part.
                <br />
                <br />
                Best regards, <br />
...
import Tooltip from "@widget/components/Tooltip";
