            ...
            <Card bodyClass=" h-full flex flex-col " className="h-full">
                <div class="flex-1 h-full">
                    ...
                    <div class="h-full pb-10 px-6" data-simplebar>
                        <ul class="list mt-6">
                            <li
                                v-for="item in filters.slice(0, 6)"
                                :key="item.label"
                            >
                                <label
                                ...
                                >
                                    ...
                                    <span
                                        class="flex-none font-normal capitalize text-sm"
                                    >
                                        {{ item.count }}</span
                                    >
                                </label>
...
import Pagination from "@widget/components/Pagination";
import Loading from "@widget/components/Skeleton/Todo";
...
.singleEmail-leave-active {
    animation: fade-in-left 0.34s cubic-bezier(0.39, 0.575, 0.565, 1) both
        reverse;
}
