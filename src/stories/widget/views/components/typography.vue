    ...
    <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
            ...
            <Card title="Texts">
                <div class="-mx-6">
                    <table class="w-full border-collapse border-none text-left">
                        <tr>
                            <th
                                class="text-xs font-semibold bg-slate-100 dark:bg-slate-700"
                            >
                                <span
                                    class="px-6 py-5 block text-slate-600 dark:text-slate-300"
                                    >Type</span
                                >
                            </th>
                            <th
        ...
        <div class="space-y-5">
            <Card title="Inline Text Elements">
                <div class="space-y-4">
                    <p
                        class="text-sm font-light text-slate-600 dark:text-slate-300"
                    >
                        Styling for common inline HTML5 elements.
                    </p>
                    <p
                        class="text-sm font-light text-slate-900 dark:text-slate-300"
                    >
                        <del
                    ...
                    >
                        <router-link to="#" class="underline"
                            ...
                            addition to the document.</router-link
                        >
                    </p>
                    <p
                        class="text-sm font-light text-slate-900 dark:text-slate-300"
            ...
            <Card title="Listing Typography">
                ...
                >
                    <div>
                        ...
                        >
                        <ul
                            class="space-y-3 p-6 rounded-md bg-slate-50 dark:bg-slate-700"
                        >
                            <li
            ...
            <Card title="Blockquotes">
                <div class="space-y-5">
                    <blockquote class="text-slate-900 dark:text-slate-300">
                        ...
                        elit. Accusamus laudantium omnis fugit ducimus nulla
                        libero temporibus corrupti non voluptatem harum?
