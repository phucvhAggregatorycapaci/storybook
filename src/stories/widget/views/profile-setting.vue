<template>
    <div class="grid grid-cols-12 gap-6">
                ...
                <div class="space-y-8">
                    ...
                    <div class="text-center">
                        <label class="cursor-pointer">
                            ...
                            <span class="btn btn-outline-dark rounded-full">
                                Upload Proifle Photo
                            </span>
                        </label>
                    </div>
                    <div class="text-sm text-slate-600 dark:text-slate-300">
                        <span class="font-bold"> Remember:</span> For best
                        results, use an image at least 200px by 200px in .jpg or
                        .png format
                    </div>
                </div>
            </Card>
        ...
        <div class="lg:col-span-9 md:col-span-7 col-span-12">
            <Card title="basic info-500">
                <form class="md:grid-cols-2 grid-cols-1 gap-6 grid">
                    <Textinput
                        label="First name"
                        name="h_Fullname"
                        type="text"
                    ...
                    <div class="md:col-span-2 col-span-1">
                        ...
                        <div class="text-right mt-6">
                            <button class="btn btn-dark rounded-full">
                                Save Changes
                            </button>
                        </div>
                    </div>
