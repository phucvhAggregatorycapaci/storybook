                    ...
                    <Card>
                        <div class="grid grid-cols-12 gap-5">
                            ...
                            <div class="xl:col-span-4 col-span-12">
                                <div
                                    class="bg-slate-50 dark:bg-slate-900 rounded-md p-4"
                                >
                                    <span
                                        class="block dark:text-slate-400 text-sm text-slate-600"
                                        >Progress</span
                                    >
                                    <apexchart
                                        type="donut"
                                ...
                                <div class="flex space-x-2 rtl:space-x-reverse">
                                    ...
                                    >
                                        ...
                                        <div class="flex-1">
                                            ...
                                            >
                                                <span
                                                    class="text-base inline-block mr-1"
                                                    ><Icon
                    ...
                    <ul class="relative ltr:pl-2 rtl:pr-2">
                        ...
                        >
                            <div class="p-[10px] relative top-[-20px]">
                                ...
                                <p
                                    class="text-xs capitalize dark:text-slate-400"
                                >
                                    {{ item.date }}
                                </p>
                            </div>
...
export default {
    async created() {
        let res = await reportApi.getRequestTicketByWeek({
            fromDate: "2023-01-01",
            toDate: "2023-06-01",
        });
        console.log(res);
        ...
        for (let d in res.data) {
            res.data[d].map((a) => data.push(a.total));
        }
        console.log(data);
