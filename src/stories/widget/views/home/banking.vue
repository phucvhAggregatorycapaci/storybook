    ...
    <div class="da">
        ...
        <div class="space-y-5 card-auto">
            <Card>
                ...
                >
                    <div
                        class="flex space-x-4 h-full items-center rtl:space-x-reverse"
                    >
                        <div class="flex-none">
                        ...
                        <div class="space-y-6">
                            ...
                            >
                                <div class="flex justify-between mb-2">
                                    <span
                                        class="text-lg text-slate-900 dark:text-white"
                                        >Contacts</span
                                    >
                                    <router-link
                                        to="#"
                            ...
                            <!-- amout start -->
                            <div
                                class="bg-slate-100 dark:bg-slate-900 rounded-md p-4"
                            >
                                <span
