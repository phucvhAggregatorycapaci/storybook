            ...
            <div class="2xl:col-span-4 lg:col-span-5 col-span-12">
                <Card title="Statistic">
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-5">
                        <div
                            class="bg-slate-50 dark:bg-slate-900 rounded pt-3 px-4"
                        >
                            <div
                        ...
                        >
                            ...
                            <div class="mt-4">
                                <apexchart
                                    ...
                                    height="44"
                                    :options="
                                        this.$store.state.themeSettingsStore
                                            .isDark
                                ...
                                <div class="flex-1">
                                    <div class="legend-ring2">
                                        <apexchart
                                            ...
                                            height="200"
                                            :options="
                                                donutChartDarkComputed.chartOptions
                                            "
                                            :series="
                                                donutChartDarkComputed.series
                                            "
                                        />
                                    </div>
                                </div>
            ...
            <div class="xl:col-span-8 lg:col-span-7 col-span-12">
                <Card title="Visitors Report">
                    ...
                    <apexchart
                        ...
                        height="350"
                        :options="
                            this.$store.state.themeSettingsStore.isDark
            ...
            return {
                ...
                chartOptions: {
                    ...
                    legend: {
                        ...
                        labels: {
                            colors: this.$store.state.themeSettingsStore.isDark
                                ? "#CBD5E1"
                                : "#475569",
                        },
                        itemMargin: {
                    ...
                    title: {
                        ...
                        offsetX: this.$store.state.themeSettingsStore.direction
                            ? "0%"
                            : 0,
                        offsetY: 13,
                        floating: false,
                        style: {
                            ...
                            fontWeight: "500",
                            fontFamily: "Inter",
                            color: this.$store.state.themeSettingsStore.isDark
                                ? "#fff"
                                : "#0f172a",
                        },
                    },
                    ...
                    yaxis: {
                        opposite: this.$store.state.themeSettingsStore.direction
                            ? true
                            : false,
                        labels: {
                            style: {
                                colors: this.$store.state.themeSettingsStore
                                    .isDark
                                    ? "#CBD5E1"
                                    : "#475569",
                                fontFamily: "Inter",
                    ...
                    grid: {
                        show: true,
                        borderColor: this.$store.state.themeSettingsStore.isDark
                            ? "#334155"
                            : "#E2E8F0",
                        strokeDashArray: 10,
                        position: "back",
