<template>
    <div
        class="space-y-5 divide-y divide-slate-100 dark:divide-slate-700 -mx-6"
    >
        <div class="px-6">
        ...
        <div class="pt-4 px-6">
            <h4
                class="text-slate-600 dark:text-slate-300 text-xl font-medium mb-4"
            >
                Latest Blogs Post
            </h4>
                ...
                <li v-for="(item, i) in posts" :key="i">
                    <div class="flex space-x-4 rtl:space-x-reverse">
                        ...
                        <div class="flex-1 flex flex-col">
                            <h4
                                class="text-sm text-slate-600 font-regular leading-5 mb-4"
                            >
                                <router-link to="#"
...
import InputGroup from "@widget/components/InputGroup";
