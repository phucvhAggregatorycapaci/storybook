            ...
            <div class="grid grid-cols-1 gap-5">
                <Card :img="post1Img">
                    ...
                    <h5 class="card-title text-slate-900">
                        <router-link :to="{ name: 'blog-details' }">
                            At Healthcare you will be treated by
                            caring</router-link
                        >
                    </h5>
                    <div
                    ...
                    >
                        ...
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit, sed do eiusmod tempor incididun ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis
                            nostrud exercitation ulla mco laboris nisi ut
                            aliquip ex ea commodo consequat. Duis aute irure
                            dolor in reprehende rit in voluptate velit esse
                    ...
                    <div class="mt-6">
                        ...
                        >
                            ...
                            <li>
                                <a href="#"
                                    ><img :src="socialImgs.twitterImg" alt=""
                                /></a>
                            </li>
                            <li>
                                <a href="#"
                                    ><img :src="socialImgs.facebookImg" alt=""
                                /></a>
                            </li>
                            <li>
                                <a href="#"
                                    ><img :src="socialImgs.linkedInImg" alt=""
                                /></a>
                            </li>
                            <li>
                                <a href="#"
                                    ><img :src="socialImgs.instagramImg" alt=""
                                /></a>
                            </li>
                        </ul>
                        <ul
                                ...
                                <div class="flex">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        >
                                            ...
                                            eiusmod tempor incididun ut lab ore
                        ...
                        >
                            ...
                            <form action="#">
                                <div
                                    class="grid lg:grid-cols-2 grid-cols-1 gap-3"
                                >
