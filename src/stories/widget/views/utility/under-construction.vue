<template>
    <div class="min-h-screen">
        <div class="absolute left-0 top-0 w-full">
            <div
                class="flex flex-wrap justify-between items-center py-6 container"
            >
                <div>
                    <router-link :to="{ name: 'home' }">
                        <img
                            ...
                            alt=""
                            v-if="!this.$store.state.themeSettingsStore.isDark"
                        />
                        <img
        ...
        <div class="container">
            ...
            >
                ...
                <h4
                    class="text-3xl font-medium text-slate-900 dark:text-white mb-2"
                >
                    We are under maintenance.
                </h4>
                <p
                    class="font-normal text-base text-slate-500 dark:text-slate-300"
                >
        ...
        <div class="fixed bottom-0 w-full">
            <div class="container">
                ...
                >
                    <div>
                        <ul
                            class="flex md:justify-start justify-center space-x-3"
                        >
                            <li>
