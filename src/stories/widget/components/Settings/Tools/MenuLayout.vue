<template>
    <div>
        ...
        <div
            ...
            v-if="
                this.$store.state.themeSettingsStore.menuLayout ===
                    'vertical' &&
                this.$store.state.themeSettingsStore.sidebarHidden === false
            "
        >
            ...
            <div>
                <label
                    :class="
                        menucollaspse ? 'bg-primary-500' : 'bg-secondary-500'
                    "
        ...
        <div
            class="flex justify-between mt-6 items-center"
            v-if="
                this.$store.state.themeSettingsStore.menuLayout === 'vertical'
            "
        >
            <div class="text-slate-600 text-base dark:text-slate-300">
                Menu Hidden
...
export default {
    data() {
        return {
            layout: this.$store.state.themeSettingsStore.menuLayout,
            menucollaspse: this.$store.state.themeSettingsStore.sidebarCollasp,
            menuHideen: this.$store.state.themeSettingsStore.sidebarHidden,
            layouts: [
                {
                    value: "vertical",
                    label: "Vertical",
    ...
    watch: {
        ...
        menuHideen: {
            handler() {
                this.$store.state.themeSettingsStore.sidebarHidden =
                    this.menuHideen;
            },
            immediate: true,
        },
        menucollaspse: {
            handler() {
                this.$store.state.themeSettingsStore.sidebarCollasp =
                    this.menucollaspse;
            },
            immediate: true,
        },
