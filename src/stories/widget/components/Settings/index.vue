<template>
    <div>
        <span
            v-if="!this.$store.state.themeSettingsStore.isOpenSettings"
            @click="
                this.$store.state.themeSettingsStore.isOpenSettings =
                    !this.$store.state.themeSettingsStore.isOpenSettings
            "
        ...
        <Transition name="lefttranslate">
            <div
                v-show="this.$store.state.themeSettingsStore.isOpenSettings"
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        @click="
                            this.$store.state.themeSettingsStore.isOpenSettings = false
                        "
                    >
