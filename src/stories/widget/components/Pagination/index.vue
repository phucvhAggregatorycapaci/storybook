    ...
    <div class="md:flex md:space-y-0 space-y-5" :class="wrapperClass">
        ...
        >
            ...
            <div class="flex items-center" v-if="enableSearch && enableSelect">
                ...
                <span
                    class="text-sm text-slate-500 inline-block ltr:ml-2 rtl:mr-2"
                >
        ...
        <ul class="pagination" :class="paginationClass">
            ...
            >
                ...
                >
                    ...
                    <span
                        v-if="enableText"
                        class="text-sm inline-block rtl:-rotate-180"
                        >Previous</span
                    >
                </button>
            </li>
            ...
            <li class="text-slate-600 dark:text-slate-300" v-if="hasFirst()">
                ...
            </li>
            ...
            <li class="text-slate-600 dark:text-slate-300" v-if="hasLast()">
                ...
            </li>
            ...
            >
                ...
                >
                    ...
                    <span
                        v-if="enableText"
                        class="text-sm rtl:-rotate-180 inline-block"
                        >Next</span
                    >
                </button>
            </li>
