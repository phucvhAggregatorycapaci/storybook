    ...
    `"
        >
            ...
            >
                ...
                <span
                    class="inline-block h-full prepend-slot"
                    v-if="$slots.prepend"
                >
            ...
            >
                ...
                <span
                    class="inline-block h-full append-slot"
                    v-if="$slots.append"
                >
...
const Cleave = require("vue-cleave-component");
export default defineComponent({
    ...
    methods: {
        toggleType() {
            ...
            this.types = this.type === "text" ? "password" : "text";
        },
    },
});
</script>
